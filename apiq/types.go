...
type UserInfo struct {
	...
	HasStoryArchive                any                    `json:"has_story_archive"`
	Username                       string                 `json:"username"`
	IsRegulatedC18                 bool                   `json:"is_regulated_c18"`
	RegulatedNewsInLocations       []any                  `json:"regulated_news_in_locations"`
	TextPostAppBadgeLabel          string                 `json:"text_post_app_badge_label"`
	ShowTextPostAppBadge           bool                   `json:"show_text_post_app_badge"`
	Pk                             string                 `json:"pk"`
	LiveBroadcastVisibility        any                    `json:"live_broadcast_visibility"`
	LiveBroadcastID                any                    `json:"live_broadcast_id"`
	ProfilePicURL                  string                 `json:"profile_pic_url"`
	HdProfilePicURLInfo            *HdProfilePicURLInfo   `json:"hd_profile_pic_url_info"`
	IsUnpublished                  bool                   `json:"is_unpublished"`
	MutualFollowersCount           any                    `json:"mutual_followers_count"`
	...
	HasChaining                    any                    `json:"has_chaining"`
	FbidV2                         string                 `json:"fbid_v2"`
	SupervisionInfo                any                    `json:"supervision_info"`
	...
	IsProfessionalAccount          any                    `json:"is_professional_account"`
	FollowerCount                  int                    `json:"follower_count"`
	AddressStreet                  any                    `json:"address_street"`
	CityName                       any                    `json:"city_name"`
	...
	LatestReelMedia                any                    `json:"latest_reel_media"`
	TotalClipsCount                int                    `json:"total_clips_count"`
	LatestBestiesReelMedia         any                    `json:"latest_besties_reel_media"`
